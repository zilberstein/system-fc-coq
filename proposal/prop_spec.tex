...
Our work is built upon the idea of formal program verification, wherein one generates a formal
model of the system under study using a theorem-proving system such as Coq, and then proves 
that this model satisfies certain desired properties. 

Some work has gone into formalizing the specification for System FC, including a basic Coq 
translation provided with the initial proposal of System FC \cite{conf/tldi/SulzmannCJD07}. 
To our knowledge, however, there has not been any substantial progress in a general proof that 
this specification is indeed sound.

\cite{conf/tldi/SulzmannCJD07}
