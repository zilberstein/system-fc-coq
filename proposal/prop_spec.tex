...
\begin{abstract}
  \textit{We plan to verify a formalized version of System FC, the core
    language of the Glascow Haskell Compiler, using the Coq proof assistant.
    We will then prove a translation from our formal language to the actual
    implementation of System FC that is used in GHC. The goals of verification
    are to prove that the evaluation semantics of System FC are type safe.
  }
