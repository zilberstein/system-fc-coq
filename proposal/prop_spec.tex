...
\noindent\textbf{\large Theorem (Soundness)} \textit{Any well-typed program will never reach a stuck state during evaluation in a consistent type system.}\\
...
\end{tikzpicture}
\begin{center}
\it Figure 2: block diagram depicting our anticipated approach
\end{center}
