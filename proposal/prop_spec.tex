...
\end{tikzpicture}
\begin{center}
\it Figure 2: Block diagram depicting our anticipated approach. The arrows on the left side represent work required to complete each given step.
\end{center}
